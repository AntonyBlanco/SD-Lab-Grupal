...
public class Proyectos extends JFrame {
    ...
    private JTextField IDProy = new JTextField(3);
    private JTextField IDDpto = new JTextField(30);
    private JTextField Nombre = new JTextField(30);
    private JTextField Fec_Inicio = new JTextField(30);
    private JTextField Fec_Termino = new JTextField(30);
    ...
    public Proyectos() {
        ...
        inputPanel.setBorder(BorderFactory.createTitledBorder("Registro de PROYECTOS"));
        ...
        addFieldLabel(inputPanel, "ID del Proyecto", IDProy, constraints, 0);
        addFieldLabel(inputPanel, "ID del Departamento", IDDpto, constraints, 1);
        addFieldLabel(inputPanel, "Nombre del proyecto", Nombre, constraints, 2);
        addFieldLabel(inputPanel, "Fecha de inicio", Fec_Inicio, constraints, 3);
        addFieldLabel(inputPanel, "Fecha de termino", Fec_Termino, constraints, 4);
        ...
        tablePanel.setBorder(BorderFactory.createTitledBorder("Tabla_Proyecto"));
